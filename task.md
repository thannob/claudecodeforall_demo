...
- [x] Curate 9-dish catalog (name, description, category, emoji)
- [x] Random-pick button ("สุ่มอาหารไทยวันนี้"), never repeats the immediately-previous dish
- [x] Favorite toggle on Today's Pick, persisted to `localStorage`
